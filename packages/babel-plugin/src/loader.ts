...
/**
 * Webpack loader that runs the same JSX transform as the Vite plugin.
 *
 * Wire it up via @pinagent/next-plugin/config or directly in next.config.js:
 *
 ...
 *         use: require.resolve('@pinagent/babel-plugin/loader'),
 *       });
 *     }
 *     return config;
 *   }
