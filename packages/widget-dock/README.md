...
Produces a standalone Vite build under `dist/`. Bundle size: ~431 kB JS / ~131 kB gz (within the 200 kB gz spec budget). Geist font subsets are split into per-script woff2s fetched on demand.
