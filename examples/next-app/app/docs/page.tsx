  ...
  return (
    ...
    >
      ...
      <p style={{ color: '#4b5563', lineHeight: 1.55 }}>
        Pinagent turns any UI element into a comment thread an agent can act on.
        Click an element in the browser, leave a note, and the agent edits the
        underlying code directly — no copying file paths, no describing where
        the element lives in your tree, no context-switching back to your
        editor.
      </p>
      <p style={{ color: '#4b5563', lineHeight: 1.55 }}>
        Under the hood, Pinagent instruments your JSX at build time so every
        rendered element carries its source location. When you click, the
        widget captures a screenshot, the surrounding DOM, and the file:line
        of the element, then hands the whole bundle to an agent.
      </p>
      ...
      <section style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        >
          ...
          <ol style={{ color: '#374151', lineHeight: 1.6, marginTop: 12, paddingLeft: 20 }}>
            ...
            <li>The widget streams the agent&apos;s output back into the page next to your element so you can watch progress in real time.</li>
            <li>Hot reload picks up the change automatically — usually within a second or two of the agent finishing.</li>
          </ol>
        </article>
        ...
        >
          ...
          <ol style={{ color: '#374151', lineHeight: 1.6, marginTop: 12, paddingLeft: 20 }}>
            <li>
              ...
              <code>npm install @pinagent/next</code>.
            </li>
            <li>
              Add the Pinagent plugin to your <code>next.config.js</code> so
              JSX gets instrumented during the build.
            </li>
            <li>
              Mount the <code>&lt;Pinagent /&gt;</code> component once in your
              root <code>app/layout.tsx</code>, after <code>{'{children}'}</code>.
            </li>
            <li>
              Run your dev server alongside the Pinagent agent runner so
          ...
          <p style={{ color: '#4b5563', lineHeight: 1.55, marginTop: 12 }}>
            ...
            Pinagent only activates in development, so there&apos;s no runtime
        ...
        >
          ...
          <p style={{ color: '#4b5563', lineHeight: 1.55, marginTop: 12 }}>
            Pinagent can route feedback to two different agent runtimes. Pick
            whichever matches how you already work.
          </p>
          <ul style={{ color: '#374151', lineHeight: 1.6, marginTop: 12, paddingLeft: 20 }}>
            <li>
              ...
              running Claude Code session as channel events you can act on
              inline. Best when you want to stay in one conversation, review
              each change, and keep full context across multiple comments.
            </li>
            <li>
              <strong>Claude Agent SDK</strong> — each comment spawns a parallel
              agent in an isolated git worktree, so concurrent edits never
              collide. Best for batches of small UI tweaks where you want
              several changes to land at once without waiting in line.
            </li>
          </ul>
        </article>
        ...
        >
          ...
          <ul style={{ color: '#374151', lineHeight: 1.6, marginTop: 12, paddingLeft: 20 }}>
            ...
            <li>Styling tweaks — &quot;add more padding&quot;, &quot;make this card border softer&quot;.</li>
        ...
        >
          ...
          <ul style={{ color: '#374151', lineHeight: 1.6, marginTop: 12, paddingLeft: 20 }}>
            ...
            <li>
              Click the element closest to what you want changed; Pinagent uses
              its file and line to anchor the edit.
            </li>
            <li>Multiple widgets can be open at once — leave several comments in a single pass.</li>
            <li>
              If a comment is ambiguous, the agent will ask a clarifying
              question through the widget rather than guess.
            </li>
            <li>
              Comments persist across reloads until they&apos;re resolved, so
              you can come back to an in-flight thread.
            </li>
          </ul>
        </article>
      </section>
