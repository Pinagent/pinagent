export default function DocsPage() {
  return (
    ...
    >
      ...
      <p style={{ color: '#4b5563', lineHeight: 1.55 }}>
        Under the hood, Pinpoint instruments your JSX at build time so every
      ...
      <section style={{ marginTop: 32, display: 'flex', flexDirection: 'column', gap: 24 }}>
        ...
        >
          ...
          <ol style={{ color: '#374151', lineHeight: 1.6, marginTop: 12, paddingLeft: 20 }}>
            <li>
              Install the Pinpoint package in your app:{' '}
              <code>npm install @pinpoint/next</code>.
            </li>
            <li>
              Add the Pinpoint plugin to your <code>next.config.js</code> so
          ...
          <p style={{ color: '#4b5563', lineHeight: 1.55, marginTop: 12 }}>
            ...
            Pinpoint only activates in development, so there&apos;s no runtime
        ...
        >
          ...
          <p style={{ color: '#4b5563', lineHeight: 1.55, marginTop: 12 }}>
            Pinpoint can route feedback to two different agent runtimes. Pick
